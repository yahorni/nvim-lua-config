return {
  ...
  keys = {
    ...
    -- git
    { "<localleader>gf", "<cmd>FzfLua git_files<cr>", desc = "Git Files" },
    { "<localleader>gs", "<cmd>FzfLua git_status <cr>", desc = "Git Status" },
    { "<localleader>gc", "<cmd>FzfLua git_commits<cr>", desc = "Git Commits" },
    { "<localleader>gB", "<cmd>FzfLua git_bcommits<cr>", desc = "Git Buffer Commits" },
    { "<localleader>gl", "<cmd>FzfLua git_blame<cr>", desc = "Git Blame" },
    { "<localleader>gb", "<cmd>FzfLua git_branches<cr>", desc = "Git Branches" },
    { "<localleader>gt", "<cmd>FzfLua git_tags<cr>", desc = "Git Tags" },
    { "<localleader>gS", "<cmd>FzfLua git_stash<cr>", desc = "Git Stash" },
    -- lsp
